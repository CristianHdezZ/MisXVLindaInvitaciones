...
const ICON_LIBRARY = {
  copa: '<path d="M8,8 L32,8 L20,22 Z" fill="var(--vino)" stroke="none"/><rect x="18.5" y="22" width="3" height="9" fill="var(--vino)" stroke="none"/><rect x="12" y="31" width="16" height="2.5" rx="1.2" fill="var(--vino)" stroke="none"/><circle cx="15" cy="12" r="1.4" fill="var(--blush)" stroke="none"/><path d="M24,9.5 C26.5,9.5 28,11.5 26,14" fill="none" stroke="var(--blush)" stroke-width="1" stroke-linecap="round"/>',
  ceremonia: '<path d="M11,5 C9,13 9,19 13,23 L13,33 L9,33 L9,35 L19,35 L19,33 L15,33 L15,23 C19,19 19,13 17,5 Z" fill="var(--vino)" stroke="none"/><path d="M29,5 C27,13 27,19 31,23 L31,33 L27,33 L27,35 L37,35 L37,33 L33,33 L33,23 C37,19 37,13 35,5 Z" fill="var(--vino)" stroke="none"/><circle cx="13" cy="13" r="0.9" fill="var(--blush)" stroke="none"/><circle cx="14.5" cy="17" r="0.7" fill="var(--blush)" stroke="none"/><circle cx="33" cy="13" r="0.9" fill="var(--blush)" stroke="none"/><circle cx="31.5" cy="17" r="0.7" fill="var(--blush)" stroke="none"/>',
  vals: '<circle cx="14" cy="8" r="3.2" fill="var(--vino)" stroke="none"/><circle cx="26" cy="8" r="3.2" fill="var(--vino)" stroke="none"/><path d="M14,12 C9,14.5 7,23 9,31 C13,33 17,33 19,31 C19,24.5 17,16 14,12Z" fill="var(--vino)" stroke="none"/><path d="M26,12 C31,14.5 33,23 31,31 C27,33 23,33 21,31 C21,24.5 23,16 26,12Z" fill="var(--vino)" stroke="none"/><line x1="19" y1="19" x2="21" y2="19" stroke="var(--vino)" stroke-width="2" stroke-linecap="round"/>',
  cena: '<circle cx="20" cy="21" r="12" fill="none" stroke="var(--vino)" stroke-width="1.6"/><circle cx="20" cy="21" r="6.5" fill="none" stroke="var(--vino)" stroke-width="1"/><path d="M7,9 L7,17 M5,9 L5,15 M9,9 L9,15 M5,15 C5,17.5 9,17.5 9,15" stroke="var(--vino)" stroke-width="1.3" fill="none" stroke-linecap="round"/><line x1="7" y1="9" x2="7" y2="34" stroke="var(--vino)" stroke-width="1.3" stroke-linecap="round"/><path d="M33,9 C35.5,11.5 35.5,15.5 33,18 L33,34" stroke="var(--vino)" stroke-width="1.3" fill="none" stroke-linecap="round"/>',
  ...
  vestido: '<path d="M20,4 C22,4 23,6 22,8 L18,8 C17,6 18,4 20,4 Z" fill="var(--vino)" stroke="none"/><path d="M18,8 L13,15 C7,20 5,28 5,35 L35,35 C35,28 33,20 27,15 L22,8 L20,15 Z" fill="var(--vino)" stroke="none"/><path d="M14,20 C17,23 23,23 26,20" stroke="var(--blush)" stroke-width="1.5" fill="none"/>',
  esmoquin: '<path d="M12,8 L16,4 L20,8 L24,4 L28,8 L26,35 L14,35 Z" fill="var(--vino)" stroke="none"/><path d="M14,16 L20,20 L14,24 Z" fill="var(--blush)" stroke="none"/><path d="M26,16 L20,20 L26,24 Z" fill="var(--blush)" stroke="none"/>',
