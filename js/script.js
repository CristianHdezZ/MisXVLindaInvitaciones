...
const ICON_SVG = {
  ...
  'traje:gala': '<path d="M24 5 C22.5 5 21.6 6.2 21.9 7.7 L22.6 12 C20.5 12.8 20 15.5 21 18 L19 27 C16 33 12 39 9 44 C15 46 33 46 39 44 C36 39 32 33 29 27 L27 18 C28 15.5 27.5 12.8 25.4 12 L26.1 7.7 C26.4 6.2 25.5 5 24 5 Z" fill="currentColor"/><path d="M22.6 12 C23.5 13 24.5 13 25.4 12" stroke="var(--blush)" stroke-width="0.7"/><path d="M13 38 C19 41 29 41 35 38" stroke="var(--blush)" stroke-width="0.7" opacity="0.7"/>',
  'traje:sirena': '<path d="M24 5 C22.5 5 21.7 6.2 22 7.6 L23 15 C21 17 21 21 22.5 24 C23.5 26 22 30 20 33 C17 37 14 41 12 44 C17 45.5 31 45.5 36 44 C34 41 31 37 28 33 C26 30 24.5 26 25.5 24 C27 21 27 17 25 15 L26 7.6 C26.3 6.2 25.5 5 24 5 Z" fill="currentColor"/><path d="M22.5 24 C23.5 25 24.5 25 25.5 24" stroke="var(--blush)" stroke-width="0.7"/>',
  'traje:corte-a': '<path d="M24 5 C22.5 5 21.6 6.3 22 7.8 L23 14 C21.5 15 21 17 22 19 L14 42 C18 44 30 44 34 42 L26 19 C27 17 26.5 15 25 14 L26 7.8 C26.4 6.3 25.5 5 24 5 Z" fill="currentColor"/><path d="M17 34 C22 36 26 36 31 34" stroke="var(--blush)" stroke-width="0.8" opacity="0.7"/>',
  'traje:lazo': '<path d="M24 5 C22.5 5 21.6 6.3 22 7.8 L22.8 13 C20.5 14 20 17 21 20 L15 42 C19 44 29 44 33 42 L27 20 C28 17 27.5 14 25.2 13 L26 7.8 C26.4 6.3 25.5 5 24 5 Z" fill="currentColor"/><path d="M18 22 L24 25 L18 28 Z M30 22 L24 25 L30 28 Z" fill="var(--oro)"/><circle cx="24" cy="25" r="1.6" fill="var(--oro)"/>',
  'traje:coctel': '<path d="M24 6 C22.5 6 21.6 7.3 22 8.8 L22.8 14 C20.8 15 20.5 18 22 21 L18 34 C21 36 27 36 30 34 L26 21 C27.5 18 27.2 15 25.2 14 L26 8.8 C26.4 7.3 25.5 6 24 6 Z" fill="currentColor"/><path d="M20 30 C23 31 25 31 28 30" stroke="var(--blush)" stroke-width="0.8" opacity="0.7"/>',
  'traje:esmoquin': '<path d="M24 8 L29 12 L33 10 L34 15 L31 18 L36 43 L28 43 L26.5 24 L24 26 L21.5 24 L20 43 L12 43 L17 18 L14 15 L15 10 L19 12 Z" fill="currentColor"/><path d="M21 13 L24 20 L27 13 L24 15 Z" fill="var(--blush)"/><path d="M20.5 12 L24 14.5 L27.5 12 L27.5 15 L24 16 L20.5 15 Z" fill="var(--oro)"/>',
  'traje:corbata': '<path d="M24 8 L30 11 L34 9 L35 14 L31 17 L35 43 L27 43 L26 22 L24 24 L22 22 L21 43 L13 43 L17 17 L13 14 L14 9 L18 11 Z" fill="currentColor"/><path d="M24 14 L26 18 L24 30 L22 18 Z" fill="var(--oro)"/><path d="M22 11 L24 14 L26 11" stroke="var(--blush)" stroke-width="1.2" fill="none"/>',
  'traje:chaleco': '<path d="M24 8 L30 11 L34 9 L35 14 L32 17 L36 43 L28 43 L27 20 L21 20 L20 43 L12 43 L16 17 L13 14 L14 9 L18 11 Z" fill="currentColor"/><path d="M21 14 L24 20 L27 14 L27 32 L21 32 Z" fill="var(--blush)"/><circle cx="24" cy="22" r="0.9" fill="var(--icono)"/><circle cx="24" cy="26" r="0.9" fill="var(--icono)"/><circle cx="24" cy="30" r="0.9" fill="var(--icono)"/>'
};
